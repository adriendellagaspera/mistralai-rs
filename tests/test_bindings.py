...
''',
    ...
    def test_metadata_pins_compiler_and_backend_contracts(self):
        ...
        self.assertIn("rust-sdk-compiler @ git+https://github.com/adriendellagaspera/mistralai-rs.git@8357b0e487bd06898099f687c9918a0c5db02db4", project["dependencies"])
        ...
        self.assertEqual(
            ...
            "8357b0e487bd06898099f687c9918a0c5db02db4",
        )
        self.assertEqual(
