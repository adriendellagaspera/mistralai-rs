...
def main() -> None:
    ...
    parser.add_argument("--bindings-root", type=Path, required=True)
    ...
    package_root = args.bindings_root.resolve()
    ...
    with tempfile.TemporaryDirectory(prefix="openapi-to-rust-bindings-") as temporary:
        ...
        for name in fixture_names:
            ...
            except Exception as error:  # surface the concrete parser failure in report
