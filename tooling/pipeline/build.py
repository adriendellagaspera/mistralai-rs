...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix=".tooling-build-", dir=ROOT) as temp:
        ...
        overlaid_openapi = work / "tooling/sources/openapi/openapi.codegen.json"
        if not overlaid_openapi.is_file():
            raise ValueError("Generator did not materialize the overlaid OpenAPI document")
        run(python, ROOT / "tooling/quality/coverage.py", work / "tooling/sources/openapi/openapi.yaml",
            overlaid_openapi, generated)
