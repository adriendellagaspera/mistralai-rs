"""Parse and validate source contracts into the closed facade IR.

This is the source-aware frontend of the generic facade compiler. It reconciles
OpenAPI, generated raw Rust, and an explicit semantic policy, but it does not
discover policy from official SDKs, render Rust, or perform repository audits.
"""
...
from sdk_ir import (ModelPolicy, RequestPolicy, SimpleUnionPolicy, StreamPolicy,
                    ViewPolicy, model_policy, stream_policy)
