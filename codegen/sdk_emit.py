...
def emit_facade_types(ir: FacadeIr) -> str:
    source = (GENERATED + "use std::pin::Pin;\nuse futures_util::Stream;\n"
              "use super::SdkError;\nuse crate::generated::types::*;\n\n")
...
def emit(ir: FacadeIr) -> dict[str, str]:
    """Render a fully resolved facade IR into its deterministic Rust file set."""
    files = {"facade_types.rs": emit_facade_types(ir), "mod.rs": emit_mod(ir)}
    for resource in ir.resources:
        ...
        files[filename] = emit_resource(resource, ir.resources)
    return files
