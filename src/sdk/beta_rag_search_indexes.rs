...
#[derive(Clone, Copy)]
pub struct BetaRagSearchIndexes<'a> {
    raw: &'a HttpClient,
}
...
impl<'a> BetaRagSearchIndexes<'a> {
    ...
    pub async fn get_deployment_summaries(
        &self,
    ) -> Result<GetDeploymentSummariesBetaRagSearchIndexesResponse, SdkError> {
        self.raw
    ...
    pub async fn unregister_deployment(
        &self,
        deployment_id: impl AsRef<str>,
    ) -> Result<UnregisterDeploymentBetaRagSearchIndexesResponse, SdkError> {
        self.raw
    ...
    pub async fn update_index_metrics(
        &self,
        deployment_id: impl AsRef<str>,
