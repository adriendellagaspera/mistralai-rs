...
#[must_use] pub fn parent_workflow_exec_id(mut self, parent_workflow_exec_id: impl Into<String>) -> Self { self.parent_workflow_exec_id = Some(parent_workflow_exec_id.into()); self }
#[must_use] pub fn stream(mut self, stream: impl Into<String>) -> Self { self.stream = Some(stream.into()); self }
#[must_use] pub fn start_seq(mut self, start_seq: i64) -> Self { self.start_seq = Some(start_seq); self }
#[must_use] pub fn metadata_filters(mut self, metadata_filters: impl Into<String>) -> Self { self.metadata_filters = Some(metadata_filters.into()); self }
#[must_use] pub fn workflow_event_types(mut self, workflow_event_types: impl Into<String>) -> Self { self.workflow_event_types = Some(workflow_event_types.into()); self }
