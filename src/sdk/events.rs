...
impl GetStreamEventsEventsRequest {
    pub fn new() -> Self {
        Self {
            scope: None,
            activity_name: None,
...
#[derive(Debug, Clone, Default)]
pub struct GetWorkflowEventsEventsRequest {
    root_workflow_exec_id: Option<String>,
    workflow_exec_id: Option<String>,
...
impl GetWorkflowEventsEventsRequest {
    pub fn new() -> Self {
        Self {
            root_workflow_exec_id: None,
            workflow_exec_id: None,
...
impl<'a> Events<'a> {
    ...
    pub async fn get_stream_events(
        &self,
        request: GetStreamEventsEventsRequest,
    ) -> Result<GetStreamEventsEventsStream, SdkError> {
        let bytes = self
            .raw
        ...
        let events = crate::streaming::json_events::<_, _, __GetStreamEventsEventsStreamItemRaw>(
            bytes,
        )
        .map(|event| {
            event
    ...
    pub async fn get_workflow_events_with(
        &self,
        request: GetWorkflowEventsEventsRequest,
    ) -> Result<GetWorkflowEventsEventsResponse, SdkError> {
        self.raw
            .get_workflow_events_v1_workflows_events_list_get(
                request.root_workflow_exec_id.as_deref(),
                request.workflow_exec_id.as_deref(),
