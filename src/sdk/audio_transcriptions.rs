...
#[derive(Clone, Copy)]
pub struct AudioTranscriptions<'a> {
    raw: &'a HttpClient,
}
...
impl<'a> AudioTranscriptions<'a> {
    ...
    pub async fn complete(
        &self,
        request: CompleteAudioTranscriptionsRequest,
    ...
    pub async fn complete_with_filenames(
        &self,
        request: CompleteAudioTranscriptionsRequest,
    ...
    pub async fn stream(
        &self,
        request: StreamAudioTranscriptionsRequest,
    ) -> Result<StreamAudioTranscriptionsStream, SdkError> {
        let bytes = self
            .raw
    ...
    pub async fn stream_with_filenames(
        &self,
        request: StreamAudioTranscriptionsRequest,
        multipart_filenames: &[(&str, &str)],
    ) -> Result<StreamAudioTranscriptionsStream, SdkError> {
