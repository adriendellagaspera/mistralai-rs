...
impl<'a> AudioVoices<'a> {
    ...
    ) -> Result<DeleteAudioVoicesResponse, SdkError> {
        self.raw
    ...
    pub async fn get_sample_audio(
        &self,
        voice_id: impl AsRef<str>,
    ) -> Result<BinaryStream, SdkError> {
        let bytes = self
            .raw
            .get_voice_sample_audio_v1_audio_voices_voice_id_sample_get_stream(voice_id.as_ref())
            .await
