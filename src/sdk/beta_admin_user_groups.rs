...
#[derive(Debug, Clone)]
pub struct AdminUserGroupsGetGroupWorkspaceAssignmentsBetaAdminUserGroupsRequest {
    group_uuid: String,
    page: Option<i64>,
    page_size: Option<i64>,
}
impl AdminUserGroupsGetGroupWorkspaceAssignmentsBetaAdminUserGroupsRequest {
...
#[derive(Debug, Clone)]
pub struct ApiAdminUserGroupsGetUserGroupMembersBetaAdminUserGroupsRequest {
    group_uuid: String,
    page: Option<i64>,
    page_size: Option<i64>,
}
impl ApiAdminUserGroupsGetUserGroupMembersBetaAdminUserGroupsRequest {
    pub fn new(group_uuid: impl Into<String>) -> Self {
        Self {
            group_uuid: group_uuid.into(),
            page: None,
...
pub struct ApiAdminUserGroupsGetUserGroupsBetaAdminUserGroupsRequest {
    page: Option<i64>,
    page_size: Option<i64>,
    search: Option<String>,
}
impl ApiAdminUserGroupsGetUserGroupsBetaAdminUserGroupsRequest {
    pub fn new() -> Self {
        Self {
            page: None,
            page_size: None,
...
#[derive(Clone, Copy)]
pub struct BetaAdminUserGroups<'a> {
    raw: &'a HttpClient,
}
...
impl<'a> BetaAdminUserGroups<'a> {
    ...
    pub async fn admin_user_groups_get_group_workspace_assignments(
        &self,
        request: AdminUserGroupsGetGroupWorkspaceAssignmentsBetaAdminUserGroupsRequest,
    ) -> Result<AdminUserGroupsGetGroupWorkspaceAssignmentsBetaAdminUserGroupsResponse, SdkError>
    {
        self.raw
            .users_admin_user_groups_get_group_workspace_assignments(
                request.group_uuid.as_str(),
                request.page,
                request.page_size,
            )
            .await
    ...
    pub async fn admin_user_groups_remove_group_from_workspace(
        &self,
    ...
    pub async fn admin_user_groups_update_group_workspace_assignment(
        &self,
        group_uuid: impl AsRef<str>,
        workspace_uuid: impl AsRef<str>,
    ...
    pub async fn api_admin_user_groups_delete_user_group(
        &self,
        group_uuid: impl AsRef<str>,
    ) -> Result<(), SdkError> {
        self.raw
            .users_api_admin_user_groups_delete_user_group(group_uuid.as_ref())
            .await
            .map_err(Into::into)
    }

    pub async fn api_admin_user_groups_get_nested_groups(
        &self,
        group_uuid: impl AsRef<str>,
    ) -> Result<ApiAdminUserGroupsGetNestedGroupsBetaAdminUserGroupsResponse, SdkError> {
        self.raw
    ...
    pub async fn api_admin_user_groups_get_user_group(
        &self,
        group_uuid: impl AsRef<str>,
    ) -> Result<ApiAdminUserGroupsGetUserGroupBetaAdminUserGroupsResponse, SdkError> {
        self.raw
    ...
    pub async fn api_admin_user_groups_get_user_group_members(
        &self,
        request: ApiAdminUserGroupsGetUserGroupMembersBetaAdminUserGroupsRequest,
    ) -> Result<ApiAdminUserGroupsGetUserGroupMembersBetaAdminUserGroupsResponse, SdkError> {
        self.raw
    ...
    pub async fn api_admin_user_groups_get_user_groups(
        &self,
    ) -> Result<ApiAdminUserGroupsGetUserGroupsBetaAdminUserGroupsResponse, SdkError> {
        self.raw
    ...
    pub async fn api_admin_user_groups_get_user_groups_with(
        &self,
        request: ApiAdminUserGroupsGetUserGroupsBetaAdminUserGroupsRequest,
    ) -> Result<ApiAdminUserGroupsGetUserGroupsBetaAdminUserGroupsResponse, SdkError> {
        self.raw
    ...
    pub async fn api_admin_user_groups_provision_group_to_workspace(
        &self,
    ...
    pub async fn api_admin_user_groups_update_user_group(
        &self,
        group_uuid: impl AsRef<str>,
