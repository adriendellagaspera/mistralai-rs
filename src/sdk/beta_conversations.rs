...
pub struct ListBetaConversationsRequest {
    page: Option<i64>,
    page_size: Option<i64>,
    metadata: Option<String>,
}
impl ListBetaConversationsRequest {
    pub fn new() -> Self {
        Self {
            page: None,
            page_size: None,
...
impl<'a> BetaConversations<'a> {
    ...
    pub async fn append(
        ...
        request: AppendBetaConversationsRequest,
    ...
    pub async fn append_stream(
        &self,
        conversation_id: impl AsRef<str>,
        request: AppendStreamBetaConversationsRequest,
    ) -> Result<AppendStreamBetaConversationsStream, SdkError> {
        let bytes = self
            .raw
    ...
    pub async fn get(
        &self,
        conversation_id: impl AsRef<str>,
    ) -> Result<GetBetaConversationsResponse, SdkError> {
        self.raw
    ...
    pub async fn get_history(
        &self,
        conversation_id: impl AsRef<str>,
    ) -> Result<GetHistoryBetaConversationsResponse, SdkError> {
        self.raw
    ...
    pub async fn get_messages(
        &self,
        conversation_id: impl AsRef<str>,
    ) -> Result<GetMessagesBetaConversationsResponse, SdkError> {
        self.raw
    ...
    pub async fn list_with(
        &self,
        request: ListBetaConversationsRequest,
    ) -> Result<ListBetaConversationsResponse, SdkError> {
        self.raw
    ...
    pub async fn restart(
        &self,
        conversation_id: impl AsRef<str>,
        request: RestartBetaConversationsRequest,
    ...
    pub async fn restart_stream(
        &self,
        conversation_id: impl AsRef<str>,
        request: RestartStreamBetaConversationsRequest,
    ) -> Result<RestartStreamBetaConversationsStream, SdkError> {
        let bytes = self
            .raw
    ...
    pub async fn start(
        &self,
        request: StartBetaConversationsRequest,
    ...
    pub async fn start_stream(
        &self,
        request: StartStreamBetaConversationsRequest,
    ) -> Result<StartStreamBetaConversationsStream, SdkError> {
        let bytes = self
            .raw
