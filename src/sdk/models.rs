...
impl<'a> Models<'a> {
    ...
    ) -> Result<ArchiveModelsResponse, SdkError> {
        self.raw
    ...
    pub async fn delete(
        &self,
        model_id: impl AsRef<str>,
    ) -> Result<DeleteModelsResponse, SdkError> {
        self.raw
    ...
    ) -> Result<ListModelsResponse, SdkError> {
        self.raw
    ...
    pub async fn retrieve(
        &self,
        model_id: impl AsRef<str>,
    ) -> Result<RetrieveModelsResponse, SdkError> {
        self.raw
    ...
    pub async fn unarchive(
        &self,
        model_id: impl AsRef<str>,
    ) -> Result<UnarchiveModelsResponse, SdkError> {
        self.raw
    ...
    ) -> Result<UpdateModelsResponse, SdkError> {
        self.raw
