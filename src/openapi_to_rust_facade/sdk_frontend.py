"""Validate OpenAPI plus explicit facade policy against normalized raw bindings.

The frontend consumes :class:`sdk_raw_ir.RawIr`; parsing generator output belongs
exclusively to :mod:`sdk_openapi_to_rust`. It does not discover policy from
official SDKs, render Rust, or perform repository audits.
"""
...
from sdk_raw_ir import (RawField as RustField, RawIr, RawOperation as RustOperation,
                        RawParameter as RustParameter, RawVariant as RustVariant)
...
def build_ir(openapi: OpenApiIndex, rust: RawIr, manifest: dict[str, Any]) -> resolved_ir.FacadeIr:
