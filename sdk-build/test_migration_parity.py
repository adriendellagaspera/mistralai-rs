"""Migration-cutover checks do not change the authoritative historical build."""

import unittest
from collections import Counter

from build import require_migration_parity


class MigrationParityTests(unittest.TestCase):
    def test_zero_rejections_and_identical_committed_facade_pass(self):
        require_migration_parity(Counter({"derived": 169, "overridden": 4}), [])
